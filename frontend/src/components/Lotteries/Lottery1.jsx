            ...
            <div className='col-lg-8'>
              <div className='section-header text-center'>
                ...
                <p className='text-gray-700 md:w-6/12 mx-auto '>
                  Buy lottery tickets online to the biggest lotteries in the
                  world offering huge jackpot prizes that you can win when you
                  play online lottery. Purchase official lottery tickets to the
                  draws listed below and receive automatic result notifications
                  and commission-free prizes when you win!
                </p>
              </div>
            </div>
          </div>
